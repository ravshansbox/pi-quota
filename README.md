...
- Reports use one compact line per provider, e.g. `claude: 7d: 89% left (1d 13h), 5h: 30% left (4h 39m)`; Codex shows its available weekly and five-hour windows, each prefixed with the short provider label
